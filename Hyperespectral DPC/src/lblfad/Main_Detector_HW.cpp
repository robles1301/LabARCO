...
void runDetector(unsigned short *input_img, const char* OutputFileName, sycl::queue &q)  
{
    ...
    std::chrono::duration<double> elapsed_stage1 = end_stage1 - start_stage1;
    std::cout << "Execution time for Stage 1: " << elapsed_stage1.count() << " seconds." << std::endl;
    ANNOTATE_SITE_END();
    //-------------------
    ...
    std::chrono::duration<double> elapsed_stage2 = end_stage2 - start_stage2;
    std::cout << "Execution time for Stage 2: " << elapsed_stage2.count() << " seconds." << std::endl;
  ...
  ANNOTATE_SITE_BEGIN("LBL_FAD_Stage2");
    ...
    std::chrono::duration<double> elapsed_stage3 = end_stage3 - start_stage3;
    std::cout << "Execution time for Stage 3: " << elapsed_stage3.count() << " seconds." << std::endl;
    ANNOTATE_SITE_END();
    //-------------------
}
